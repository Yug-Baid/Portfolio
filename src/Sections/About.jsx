...
const About = () => {
  ...
  return (
    <section id="About" className="bg-black rounded-b-4xl min-h-screen py-12 sm:py-16 md:py-20 lg:py-24">
      <AnimatedHeader
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 mt-8 sm:mt-10 md:mt-12">
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20 items-start mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="relative">
            <div
              ref={imageRef}
              className="relative w-full h-[400px] sm:h-[500px] md:h-[550px] lg:h-[650px] rounded-2xl sm:rounded-3xl overflow-hidden"
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 md:p-10 lg:p-12 pointer-events-none">
                <h3 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-amiamie text-white mb-2 sm:mb-3 md:mb-4 leading-none tracking-tight" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.8)' }}>
                  YUG JAIN<span className="text-gold">.</span>
                </h3>
                <p className="text-gold/90 text-base sm:text-lg md:text-xl lg:text-2xl font-light tracking-wide">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h4 className="text-xl sm:text-2xl md:text-3xl font-amiamie text-gold mb-3 sm:mb-4">
                Who Am I?
              </h4>
              <p className="text-white/70 text-base sm:text-lg md:text-xl font-light leading-relaxed mb-4 sm:mb-6">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-4 p-4 sm:p-5 min-h-[60px] rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all group"
              >
                ...
                <div>
                  ...
                  <p className="text-white group-hover:text-gold transition-colors text-sm sm:text-base break-all">yugbaid4@gmail.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-white group-hover:text-gold transition-colors text-sm sm:text-base">+91 98765 43210</p>
                </div>
              </a>
            </div>
          </div>
        ...
        {/* Skills Section */}
        <div ref={skillsRef}>
          <h4 className="text-2xl sm:text-3xl md:text-4xl font-amiamie text-white mb-8 sm:mb-10 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {skills.map((skillGroup, index) => (
              <div
                key={index}
                className="p-6 sm:p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-gold/30 transition-all group"
              >
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <div className="p-2 rounded-xl bg-gold/10">
                    <Icon icon={skillGroup.icon} className="flex items-center justify-center text-gold text-2xl" />
                  </div>
                  <h5 className="text-xl sm:text-2xl font-amiamie text-gold group-hover:text-white transition-colors">
                    {skillGroup.category}
                  </h5>
                </div>
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  {skillGroup.items.map((skill, idx) => (
                    <span
                      key={idx}
                      className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/5 border border-white/10 rounded-full text-white/80 text-xs sm:text-sm font-light hover:bg-gold/10 hover:border-gold/30 hover:text-white transition-all"
                    >
                      {skill}
                    </span>
                  ))}
